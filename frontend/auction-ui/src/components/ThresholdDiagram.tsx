...
export default function ThresholdDiagram() {
    ...
    <div className='mt-[600px] pt-12' id='ThresholdAuction'>
        ...
        <div className='row-start-1 row-span-1 col-start-1 md:col-span-6 md:mt-24 mt-0 lg:mt-0 lg:col-span-7 items-end justify-center item-hover hidden md:block '>
            <img className='xl:w-screen lg:w-screen lg:ml-16 md:block hidden' src={threshold} alt="Threshold Diagram" />
            <img src={ellipse} alt="Straightline" className='lg:ml-16 absolute w-[1200px] h-[500px] ml-[0px] mt-[-500px] z-[-1] opacity-65 item-hover-more' />
        </div>
        ...
        <div className='xl:mt-[70px] lg:mt-[-10px]'>
            ...
            <h2 className="lg:mr-24 xl:mr-32 mt-2 text-sm xs:text-lg bg-clip-text text-transparent bg-gradient-to-b from-white/90 to-[#8BA2C8]">
                TACo (Threshold Access Control) <br/>end-to-end encrypted data sharing<br/> powered by Threshold
            </h2>

            <div className="flex flex-col text-left gap-5 xl:ml-12 lg:ml-2 md:m-8 m-4 ml-8 md:mb-0 mb-[-10px]">
                
                <div className="flex flex-row mt-5 ">
                <div><img className='h-[50px]' src={magic_icon} alt="smart contract security tooling" /></div>
                ...
                <div><img className='h-[50px]' src={personUp_icon} alt="risk management tooling for DeFi Protocols" /></div>
                <div className='flex flex-col cont'>
                <h2 className='text-lg font-bold'>
                    Grow your NFT Collection
                </h2>
                <h3 className='text-sm'>
                    Every Auction brings new Opportunites</h3>
                </div>
                </div>

                <div className="flex flex-row">
                <div><img className='h-[50px]' src={smile_icon} alt="AI security simulation engine for web3" /></div>
                <div className='flex flex-col cont'>
                <h2 className='text-lg font-bold'>
                    Get Lucky
                </h2>
                <h3 className='text-sm'>
                    Win a hidden gem, a valuable NFT can be drawn</h3>
                </div>
                </div>
