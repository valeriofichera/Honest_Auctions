...
function LogoSlider() {
  const logos = [fuel, arb, base, threshold, linea, moonbeam, fhenix, artela, fuel, arb, base, threshold, linea, moonbeam, fhenix, artela, fuel, arb, base, threshold, linea, moonbeam, fhenix, artela]
  return (
