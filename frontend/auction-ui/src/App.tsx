...
import { mainnet, goerli, arbitrum, arbitrumGoerli, baseGoerli, foundry, hardhat } from "wagmi/chains"
...
function App() {
	...
	const { chains, provider } = configureChains(
		[mainnet, goerli, arbitrum, arbitrumGoerli, baseGoerli, foundry, hardhat],
