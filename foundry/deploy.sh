...
forge script script/DenverAuctionNFT.s.sol:DeployDenverAuctionNFT --fork-url $MOONBEAM_RPC_URL --private-key $PRIVATE_KEY --broadcast --etherscan-api-key $ETHERSCAN_API_KEY --verify -vvv
...
forge script script/EnglishAuction.s.sol:DeployEnglishAuction --fork-url $MOONBEAM_RPC_URL --private-key $PRIVATE_KEY --broadcast --etherscan-api-key $ETHERSCAN_API_KEY --verify -vvv
